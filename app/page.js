        ...
        <div className="container">
          ...
          <div className="features-grid stagger">
            ...
            <article className="feature-card reveal" style={{ '--i': 1 }}>
              <div className="feature-icon">NO</div>
              <h3 className="feature-title">Notifikasi Cerdas</h3>
              <p className="feature-desc">Imam mendapat pengingat otomatis dari H-1 hingga 15 menit sebelum waktu shalat tiba. Tidak perlu hubungi satu per satu.</p>
            </article>

            <article className="feature-card reveal" style={{ '--i': 2 }}>
              <div className="feature-icon">IM</div>
              <h3 className="feature-title">Manajemen Imam</h3>
              <p className="feature-desc">Imam utama berhalangan? Cukup satu klik, sistem langsung memberikan notifikasi ke Imam Cadangan.</p>
            </article>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="testimonials-grid stagger">
            ...
            <article className="testi-card reveal" style={{ '--i': 0 }}>
              <div className="testi-stars">5/5</div>
              <div className="testi-quote">
                <p>"Alhamdulillah, jadwal jadi rapi. Saya diingatkan untuk bersiap 15 menit sebelum tugas. Sangat membantu kekhusyukan."</p>
              </div>
