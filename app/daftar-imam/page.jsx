...
export const metadata = {
  title: 'Daftar Imam | SiJimat',
  description: 'Daftarkan diri Anda sebagai Imam Tarawih melalui SiJimat.',
}
      ...
      <main style={{ minHeight: '100vh', background: 'linear-gradient(to bottom, #ecfdf5, #ffffff)', padding: '2rem 1rem' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h2 style={{ fontSize: '1.6rem', fontWeight: '700', color: '#111827', marginBottom: '0.5rem' }}>
            Pendaftaran Imam Tarawih
          </h2>
          <p style={{ color: '#6b7280', fontSize: '0.9rem', maxWidth: '380px', margin: '0 auto' }}>
            Isi formulir di bawah ini. Pengurus masjid akan menghubungi Anda
            melalui WhatsApp untuk konfirmasi jadwal.
          </p>
        </div>
...
async function ExistingImamGate({ existingImamPromise }) {
  ...
  return (
    <div style={{
      ...
      {existingImam ? (
        <div style={{ textAlign: 'center', display: 'grid', gap: '0.8rem' }}>
          <h3 style={{ color: '#111827', fontSize: '1.15rem', fontWeight: '800' }}>
            Data imam sudah terdaftar
          </h3>
          <p style={{ color: '#6b7280', fontSize: '0.9rem' }}>
            Akun ini sudah punya data imam atas nama <strong>{existingImam.nama}</strong>. Perubahan data dilakukan lewat halaman profil.
          </p>
          <Link
            href="/profile"
            style={{
