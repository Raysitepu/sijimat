      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        <div>
          ...
          <input
            ...
            required
            style={{ width: '100%', padding: '0.7rem 1rem', borderRadius: 'var(--radius-sm)', border: '1.5px solid var(--glass-border)', background: 'var(--bg)', fontFamily: 'var(--font-body)', fontSize: '0.88rem', color: 'var(--text)', outline: 'none' }}
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            required
            rows={4}
            style={{ width: '100%', padding: '0.7rem 1rem', borderRadius: 'var(--radius-sm)', border: '1.5px solid var(--glass-border)', background: 'var(--bg)', fontFamily: 'var(--font-body)', fontSize: '0.88rem', color: 'var(--text)', outline: 'none', resize: 'vertical' }}
          />
        </div>
