'use client'
// components/DaftarForm.jsx
// Form dengan validasi Zod + tampilan error per field
...
// Komponen input dengan tampilan error
      ...
      {state.status !== 'success' && (
        <form action={formAction} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <InputField
            ...
            name="nama"
            placeholder="Ust. Abdullah Fauzi"
            error={errors.nama}
          />
