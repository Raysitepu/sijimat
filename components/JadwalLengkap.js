// SERVER COMPONENT - Halaman utama /
...
export default function HomePage() {
  return (
    <main>
                    ...
                    <li key={imam.id} className={`jadwal-item${index === 0 ? ' active' : ''}`}>
                      <div className="jadwal-item-left">
                        <div
                          ...
                          style={imam.warna ? { background: imam.warna } : {}}
                        >
                          {imam.inisial}
                        </div>
                        <div>
      ...
      {/* ============================================================
          JADWAL LENGKAP 30 MALAM
          Tombol "Lihat Jadwal 30 Malam" ada di sini
          Kalau diklik, langsung muncul tabel di bawahnya
      ============================================================ */}
      <section id="jadwal" style={{ padding: 'clamp(3rem, 8vw, 5rem) 0', background: 'var(--bg-deep)' }}>
        <div className="container">
          ...
          {/* Client Component: tombol + tabel 30 malam */}
          <JadwalLengkap />
        </div>
      </section>
